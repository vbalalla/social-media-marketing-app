package io.serendia.inbox.security;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    public JwtAuthenticationFilter(
        ...
        try {
            ...
            throw new IllegalStateException("Failed to initialize JWT public key in inbox-service", e);
        }
    }
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            log.debug("JWT verification failed in inbox-service: {}", e.getMessage());
        }

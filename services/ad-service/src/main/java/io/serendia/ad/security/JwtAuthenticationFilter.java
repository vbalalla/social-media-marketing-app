package io.serendia.ad.security;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    public JwtAuthenticationFilter(
        ...
        try {
            ...
            throw new IllegalStateException("Failed to initialize JWT public key in ad-service", e);
        }
    }
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            log.debug("JWT verification failed in ad-service: {}", e.getMessage());
        }
